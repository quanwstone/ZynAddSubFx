...
void Reverb::setpreset(unsigned char npreset){
 ...
 //   	//Cathedral2
	...
	unsigned char presets[NUM_PRESETS][PRESET_SIZE]={
	  ...
	  //  平衡 延迟
		//Cathedral1
		//{80,64,63,24,0,0,0,85,5,83,1,54},
		//{80,64,43,4,0,0,0,85,5,83,1,54},//音乐厅
		{80,64,43,3,0,0,0,85,5,83,1,54},//音乐厅
		//Cathedral2
		{80,64,49,6,0,0,0,127,0,71,0,64},//教堂
		//Cathedral3
		//{80,64,59,4,0,0,0,127,15,78,1,70},//体育馆
		{80,64,59,16,0,0,0,127,15,78,1,70},//体育馆
		//Hall1
		{90,64,51,10,0,0,0,127,21,78,1,64},//礼堂
		//Hall2
		{90,64,53,20,0,0,0,127,55,71,1,64},//大厅
		//Room1
		{100,64,33,1,0,0,0,127,0,106,0,30},//车库
		//Room2
		//{100,64,21,26,0,0,0,62,0,77,1,45},//起居室
		{100,64,21,13,0,0,0,62,0,77,1,45},//起居室
		//Basement
		{110,64,14,1,0,0,0,127,5,71,0,25},//地下室
		//Echoed1
		{120,64,26,10,71,0,0,114,0,64,1,30},//浴室
		//Tunnel
		{85,60,44,10,22,0,0,100,0,78,1,95},//隧道
		//Echoed2
		{90,64,40,58,71,0,0,114,0,88,1,64},//山洞
		//VeryLong1
		{90,64,53,15,0,0,0,114,0,77,0,95},
		//VeryLong2
		{90,64,71,30,0,0,0,114,90,74,1,70}};
...
void Reverb::changepar(int npar,unsigned char value){
    switch (npar){
	case 0: setvolume(value);//干湿
		break;
	case 1: setpan(value); //平衡(左右?)
		break;
	case 2: settime(value);//特效持续时间
		break;
	case 3: setidelay(value); //延迟(处理后的声音和原音的间隔)
		break;
	case 4: setidelayfb(value); //延迟回馈
		break;
	//case 5: setrdelay(value);
	//	break;
	//case 6: seterbalance(value);
	//	break;
	case 7: setlpf(value); //低通
		break;
	case 8: sethpf(value); //高通
		break;
	case 9: setlohidamp(value);//频率衰减
		break;
	case 10:settype(value);
		break;
	case 11:setroomsize(value); //房间大小
		break;
    };
};
...
//		break;
	case 7: return(Plpf); //低通
		break;
	case 8: return(Phpf); //高通
		break;
